...
Education, healthcare, hunger, access to clean water, disaster relief, environmental preservation, and support for the underprivileged are just a few of the social issues that the charity has a big impact on. Numerous restrictions apply to the current charity, including poor administration, excessive operating expenses, and a lack of transparency in the donation execution process. Regarding actual appearance, a major issue with the current system is user and institution authentication. In this study, blockchain technology offers the capability of an immutable and traceable distributed ledger for the transactions of charity funds, resolving the issues of transparency and dependability. We have the creativity to use Know Your Customer (KYC), cryptographic HASH, and blockchain technology to strengthen the centralised traditional charitable work that already exists. This suggested strategy fits every need of the current framework for traditional charities. Smart contract filters are used to implement personal information privacy. Two important contributions of this work are the modified KYC implementation that ensures authenticity and secure data transfer from end users to the platform. Both a random time delay between data to prevent guessing for attack and a coin toss method for data selection for travelling over the channel make it difficult to attack. We want this framework to be extremely liquid and transfer all donations to the intended recipients, closing the funding gap for the UN Sustainable Development Goals (SDG). To widen the categories of charitable acts in which people contribute their skills and services, we also propose the idea of service charity in this study.
